      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg text-muted-foreground mb-8 md:mb-12">
            Whether you're scrolling Instagram or browsing online, we work with hundreds of brands to bring you instant discount codes - and every purchase supports the influencers you trust.
          </p>
